    ...
    <div className="flex  mt-5 justify-between">
      <div className="flex gap-x-5 items-center">
        ...
        <Select>
          ...
          <SelectContent>
            <SelectItem value="Availability:All">Availability:All</SelectItem>
            <SelectItem value="Availability:In stock">Availability:In stock</SelectItem>
            <SelectItem value="Availability:Out of stock">Availability:Out of stock</SelectItem>
          </SelectContent>
        </Select>
      </div>
